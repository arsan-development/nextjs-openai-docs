...
Takes all `.mdx` files in the `pages` directory and processes them to use as custom context within OpenAI text completion prompts.

## Technical Details

Building your own custom chat docs involves four steps:
